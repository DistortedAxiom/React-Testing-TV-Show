...
test("App fetch data and render shows", async () => {
    mockFetchShow.mockResolvedValueOnce(show_data);
    const { queryAllByText } = render(<App />);
    await waitFor(() =>
        expect(queryAllByText(/stranger things/i)),
        expect(queryAllByText(/select a season/i))
    )
  });
